...
if __name__ == "__main__" :
	...
	parser.add_argument('--cadbiomFile', type=str, help=' enter a file path to generate the Cadbiom model.')
	...
	createCadbiomFile(dictTransition, dictPhysicalEntity, cadbiomModelName, args.cadbiomFile)
